typedef int ElementType;
    ...
    //  #define Capacity (1073741823)
        ...
        BinQueue Insert(ElementType position , ElementType constexetime , double priorityValue , ElementType arrivaltime ,
		int firstcondition , int waitingtime , BinQueue H );
        void preMechaSchedule(BinQueue H , int eMax , int q);
        ElementType DeleteMin( BinQueue H );
        BinQueue Merge( BinQueue H1, BinQueue H2 );
        BinTree FindMin( BinQueue H );
